...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.touchShortcutItem = [[BHShortcutItem alloc] init];
#endif

        self.openURLItem = [[BHOpenURLItem alloc] init];
        self.notificationsItem = [[BHNotificationsItem alloc] init];
        self.userActivityItem = [[BHUserActivityItem alloc] init];
        self.backgroundItem = [[BHBackgroundItem alloc] init];
    }
