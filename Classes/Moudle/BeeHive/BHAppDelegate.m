...
- (BOOL)application:(UIApplication *)app openURL:(NSURL *)url options:(NSDictionary<NSString *,id> *)options
{
    ...
    if (@available(iOS 9.0, *)) {
        [[BeeHive shareInstance].context.openURLItem setSourceApplication:[options objectForKey:UIApplicationOpenURLOptionsSourceApplicationKey]];
    }
    if (@available(iOS 9.0, *)) {
        [[BeeHive shareInstance].context.openURLItem setAnnotation:[options objectForKey:UIApplicationOpenURLOptionsAnnotationKey]];
    }
...
{
    [[BeeHive shareInstance].context.backgroundItem setSessionIdentifier:identifier];
    [[BeeHive shareInstance].context.backgroundItem setHandler:completionHandler];
    [[BHModuleManager sharedManager] triggerEvent:BHMHandleBackgroundSessionEvent];
}
@end
...
@implementation BHBackgroundItem
